...
class ProductPage(BasePage):
    ...
    def should_be_success_message(self):
        assert self.is_element_present(*ProductPageLocators.ADDED_PRODUCT), "Success message is not present, but should be"

    def should_not_be_success_message(self):
        assert self.is_not_element_present(
            *ProductPageLocators.ADDED_PRODUCT), "Success message is present, but should not be"
